...
namespace BE
{
    ...
    {
        //Cette classe nous donne la ligne
    ...
    //Cette classe nous donne des infos sur l'aeroport
    {
    ...
    {
        //(IATA:TLV, IACO:LLBG)
        //Cette classe code nous donne les ville de depart et d'arriver
